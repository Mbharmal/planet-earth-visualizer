...
export function JourneyPicker({ journeys, onSelect, onClose }: JourneyPickerProps) {
  return (
    <div className={styles.backdrop} onClick={onClose}>
      <div className={styles.panel} role="dialog" aria-label="Choose a journey" onClick={(e) => e.stopPropagation()}>
        ...
        <p className={styles.tagline}>Follow a life across the globe, chapter by chapter.</p>
            ...
            <li key={journey.id}>
              <button className={styles.item} onClick={() => onSelect(journey.id)}>
                ...
                <span className={styles.itemText}>
                  <span className={styles.person}>{journey.person}</span>
